...
export default function LessonResources({ courseSlug, lessonSlug }: LessonResourcesProps) {
  ...
  const resources = {
    ...
    items: [
      ...
      {
        title: "Code Examples",
        description: "Sample code demonstrating the concepts covered in this lesson.",
        type: "code",
        size: "156 KB",
        url: "#",
      },
      {
        ...
        description: "Full transcript of the lesson video.",
        type: "text",
        size: "85 KB",
        url: "#",
      },
    ...
    links: [
      {
        ...
        description: "Reference documentation for the concepts covered in this lesson.",
        url: "#",
      },
      {
        title: "Additional Reading",
        description: "Supplementary materials to deepen your understanding.",
        url: "#",
      },
    ],
  }
