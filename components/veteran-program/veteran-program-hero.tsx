        ...
        <div className="flex flex-col md:flex-row items-start">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 text-lg rounded-xl shadow-lg hover:shadow-blue-500/20 transition-all duration-300"
                asChild
              >
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-blue-900/30 backdrop-blur-sm border border-blue-800/50 rounded-xl p-6 shadow-xl">
