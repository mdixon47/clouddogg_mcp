        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Veteran-owned AI automation company connecting your AI to thousands of apps through Zapier's Model Context
              Protocol.
            </p>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Learning</h3>
            <ul className="space-y-2">
              <li>
                <a
                  href="/learn"
              ...
              <li>
                <a
                  href="/learn/veteran-entrepreneurs"
                  className="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors"
                >
                  Veteran Program
                </a>
