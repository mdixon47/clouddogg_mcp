    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 to-gray-900 text-gray-100">
      <div className="relative overflow-hidden">
        ...
        <main className="pt-20 pb-20">
          <LessonNavigation courseSlug={params.courseSlug} lessonSlug={params.lessonSlug} />

          <div className="px-4 md:px-8 py-8">
            <div className="max-w-5xl mx-auto">
              <LessonContent courseSlug={params.courseSlug} lessonSlug={params.lessonSlug} />
              <LessonQuiz courseSlug={params.courseSlug} lessonSlug={params.lessonSlug} />
              <LessonResources courseSlug={params.courseSlug} lessonSlug={params.lessonSlug} />
            </div>
          </div>

          <LessonProgress courseSlug={params.courseSlug} lessonSlug={params.lessonSlug} />
        </main>
        <Footer />
      </div>
    </div>
